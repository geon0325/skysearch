...
class Discriminator(nn.Module):
    def __init__(self, in_channels=1):
        ...
        self.block1 = nn.Sequential(*discriminator_block(in_channels, 64, normalization=False))
